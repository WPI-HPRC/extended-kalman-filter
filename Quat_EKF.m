...
x_min = [q_0; bG_x; bG_y; bG_z; bA_x; bA_y; bA_z];
x     = x_min;
...
Q_k(5:7, 5:7) = eye(3) * std_dev_gyrBias.^2;

Q_k(8:10, 8:10) = eye(3) * std_dev_accBias.^2;
...
for i = 2:length(imu_data.time)
    ...
    h_accel = R_TB' * G_NED + [x_min(8); x_min(9); x_min(10)];

    z_accel = imu_data.accelerometer(1:3, i) - [x_min(8); x_min(9); x_min(10)];
